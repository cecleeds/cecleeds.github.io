...
<p aria-label="Phone number {{ sl_details.sr_phone }}">Mobile Number: {{ sl_details.phone }}</p>
...
<p aria-label="Phone number {{ dsl_details.sr_phone }}">Mobile Number: {{ dsl_info.phone }}</p>
